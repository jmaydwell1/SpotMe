...
public class TestPMActivity extends AppCompatActivity {
...
//        progressBar.setVisibility(View.VISIBLE);
        ...
        adapter = new PotentialMatchAdapter(TestPMActivity.this, potentialMatches, loginId);
                    ...
                    public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                        ...
                        for (DocumentChange dc : value.getDocumentChanges()) {
                            if (dc.getType() == DocumentChange.Type.ADDED) {
                                // filter here?
                                PotentialMatch data = dc.getDocument().toObject(PotentialMatch.class);
    ...
    private void onSwipeConfig() {
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                new RecyclerViewSwipeDecorator.Builder(TestPMActivity.this, c, recyclerView, viewHolder, dX, dY, actionState, isCurrentlyActive)
